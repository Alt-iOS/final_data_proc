...
def run():
    # Genera una matriz de distancias de Ciudades x nCiudades
    ...
    # Evapora todas las feromonas multiplicándolas por una constante #= 0.9
    # (en otras palabras, el coeficiente de evaporación es 0.1)
    ...
    def hormigas(distancias, iteraciones, distMedia):
        ...
        # En cada iteración se genera una hormiga, que elige un camino, # y si es mejor que el mejor que teníamos, deja su rastro de # feromonas (mayor cuanto más corto sea el camino)
